...
class Statlog_german_credit:
    ...
    def __init__(self):
        ...
        # change scoring strategy to minimum the cost matrix
        self.scoring = sklearn.metrics.make_scorer(self.loss_func , greater_is_better = False)
        
    @staticmethod
    def loss_func(y, y_pred, **kwargs):
        """
        weighted cost matrix
        
        """
        return np.sum(sklearn.metrics.confusion_matrix(y,y_pred) * np.array([0,1,5,0]).reshape(2,2))
    ...
    def k_nearest_neighbours(self):
        ...
        knn = K_nearest_neighbours(x_train= self.x_train,
                                   ...
                                   n_jobs=-1)
        self.rs_cost.append(self.loss_func(self.y_train, knn.predict(self.x_train)))
        self.rs_cost.append(self.loss_func(self.y_test, knn.predict(self.x_test)))
    ...
    def support_vector_classifier(self):
        ...
        self.rs_cost.append(self.loss_func(self.y_train, svm.predict(self.x_train)))
        self.rs_cost.append(self.loss_func(self.y_test, svm.predict(self.x_test)))

        # return the accuracy score
        return (svm.evaluate(data=self.x_train, targets=self.y_train),
                svm.evaluate(data=self.x_test, targets=self.y_test))
#         return (self.loss_func(self.y_train, svm.predict(self.x_train)),
#                 self.loss_func(self.y_test, svm.predict(self.x_test)))
    ...
    def decision_tree_classifier(self):
        ...
        self.rs_cost.append(self.loss_func(self.y_train, dtc.predict(self.x_train)))
        self.rs_cost.append(self.loss_func(self.y_test, dtc.predict(self.x_test)))
        
        return (dtc.evaluate(data=self.x_train, targets=self.y_train),
                dtc.evaluate(data=self.x_test, targets=self.y_test))   
        # return the accuracy score
#         return (self.loss_func(self.y_train, dtc.predict(self.x_train)),
#                 self.loss_func(self.y_test, dtc.predict(self.x_test)))
    ...
    def random_forest_classifier(self):
        ...
        self.rs_cost.append(self.loss_func(self.y_train, rfc.predict(self.x_train)))
        self.rs_cost.append(self.loss_func(self.y_test, rfc.predict(self.x_test)))

        # return the accuracy score
        return (rfc.evaluate(data=self.x_train, targets=self.y_train),
                rfc.evaluate(data=self.x_test, targets=self.y_test))        
#         return (self.loss_func(self.y_train, rfc.predict(self.x_train)),
#                 self.loss_func(self.y_test, rfc.predict(self.x_test)))
    ...
    def ada_boost_classifier(self):
        ...
        self.rs_cost.append(self.loss_func(self.y_train, abc.predict(self.x_train)))
        self.rs_cost.append(self.loss_func(self.y_test, abc.predict(self.x_test)))

        # return the accuracy score
        return (abc.evaluate(data=self.x_train, targets=self.y_train),
                abc.evaluate(data=self.x_test, targets=self.y_test))        
#         return (self.loss_func(self.y_train, abc.predict(self.x_train)),
#                 self.loss_func(self.y_test, abc.predict(self.x_test)))
    ...
    def logistic_regression(self):
        ...
        self.rs_cost.append(self.loss_func(self.y_train, lr.predict(self.x_train)))
        self.rs_cost.append(self.loss_func(self.y_test, lr.predict(self.x_test)))
...
#         return (self.loss_func(self.y_train, lr.predict(self.x_train)),
#                 self.loss_func(self.y_test, lr.predict(self.x_test)))
    ...
    def gaussian_naive_bayes(self):
        ...
        self.rs_cost.append(self.loss_func(self.y_train, gnb.predict(self.x_train)))
        self.rs_cost.append(self.loss_func(self.y_test, gnb.predict(self.x_test)))

        # return the accuracy score
        return (gnb.evaluate(data=self.x_train, targets=self.y_train),
                gnb.evaluate(data=self.x_test, targets=self.y_test))
        # return the accuracy score
#         return (self.loss_func(self.y_train, gnb.predict(self.x_train)),
#                 self.loss_func(self.y_test, gnb.predict(self.x_test)))
    ...
    def neural_network_classifier(self):
        ...
        self.rs_cost.append(self.loss_func(self.y_train, nnc.predict(self.x_train)))
        self.rs_cost.append(self.loss_func(self.y_test, nnc.predict(self.x_test)))
        ...
        # return the accuracy score
#         return (self.loss_func(self.y_train, nnc.predict(self.x_train)),
#                 self.loss_func(self.y_test, nnc.predict(self.x_test)))
