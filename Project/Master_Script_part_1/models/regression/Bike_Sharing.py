...
class Bike_sharing:
    ...
    def ada_boost_regression(self):
        ...
        # n_estimators = np.logspace(start=2, stop=4, base=2, num=4, dtype=np.int)
        ...
        # Parameter
        # range: {'n_estimators': array([4, 16, 32, 64]),
        ...
        np.random.seed(0)
        n_estimators = scipy.stats.norm(64,10).rvs(10).astype(np.int)
    ...
    def gaussian_process_regression(self):
        ...
        np.random.seed(0)
        alpha = scipy.stats.norm(1.e-10, 0.01).rvs(100)
